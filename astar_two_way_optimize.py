...
if __name__ == "__main__":
    ...
    result_path = f"/data2/lhy/project/MonaLisaTSP/result/astar_two_way_{args.nearest_node_num}_result.json"
    ...
    node_order, path_length = astar_searcher.astar_search_two_way(nearest_node_num=args.nearest_node_num)
